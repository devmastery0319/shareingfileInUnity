...
Online documentation & example code available at: https://github.com/devmastery/UnityNativeShare
...
- (optional) change the value of 'Photo Library Usage Description' at 'Project Settings/devmastery/Native Share'

b. Manual Setup for iOS
- set the value of 'Automated Setup' to false at 'Project Settings/devmastery/Native Share'
- build your project
